...
describe('EvoUiClass binding to CSS class list', () => {
    ...
    // eslint-disable-next-line prefer-arrow/prefer-arrow-functions
    function prefixClassNames(classes: string) {
        if (!classes) {
            return '';
        }
    ...
    describe('expressions evaluating to lists', () => {
        ...
        it('should throw with descriptive error message when CSS class is not a string', () => {
            ...
            expect(() => fixture?.detectChanges())
                .toThrowError(/EvoUiClass can only toggle CSS classes expressed as strings, got \[object Object]/);
        });
    });
    ...
    describe('cooperation with other class-changing constructs', () => {
        ...
        it('should co-operate with the interpolated class attribute when interpolation changes', async(() => {
            fixture = createTestComponent(`<div [evoUiClass]="{large: false, small: true}" class="${prefix} {{strExpr}}"></div>`);
